  ...
  >
    <div class="container-fluid">
      ...
      <a class="navbar-brand logo ml-2" href="/">
        <!-- <img v-if="lang == 'ru'" src="@/assets/images/Group5.png" alt class="logo-dark" height="48" />
        <img v-if="lang == 'ru'" src="@/assets/images/Group5.png" alt class="logo-light" height="48" /> -->

        <img
          src="@/assets/images/design/logo-dark.png"
          alt
          class="logoImg1"
          height="40"
        />
        <img src="@/assets/logo-min.png" alt class="logoImg" height="48" />
        <!-- <img  src="@/assets/images/design/logo1.svg" alt class="logo-light" height="48" /> -->
      </a>
      <!-- <button
      ...
      <div class="d-flex align-items-center mr-4">
        ...
        <div v-if="isToken">
          <i
            ...
            class="mdi h2 mdi-account-circle text-primary"
          ></i>
          <!-- <b-button v-if="!isToken" @click="$store.state.isOpenSidebar = true" variant="primary" size="sm"> {{ $t('login') }} </b-button> -->
        </div>
      </div>
    </div>
    <b-sidebar
        ...
        >
                ...
                <b-row v-if="filter.isPassword === false">
                  ...
                  >
                    <!-- <custom-input
                      ...
                      v-model="CheckPerson.serianumber"
                    ...
                    <custom-datepicker
                      ...
                      v-model="CheckPerson.passportDate"
                    >
                    </custom-datepicker>
                  </b-col>
                  <b-col
                  ...
                  <!-- <b-col sm="12" style="margin-bottom: 9px" class="text-right">
                    <div
                      class="text-primary"
                      @click="$bvModal.show('PinflModal')"
                    >
                      <span style="cursor: pointer">{{ $t("pinfl") }}?</span>
                    </div>
                  </b-col> -->
                  ...
                  <!-- <b-col
                    sm="12"
                    style="margin-bottom: 9px"
                    v-if="immediate == false && showSMSTime"
                  >
                    <span>{{ $t("restoresmstime") }}</span>
                    <span style="color: red">
                      {{ minCount }} <span style="color: red">:</span>
                      {{ countDown }}</span
                    >
                  </b-col>
                  <b-col
                  ...
                  >
                    <span
                      style="cursor: pointer"
                      class="text-primary"
                      @click="sendsmsrestore"
                      >{{ $t("restorecodesms") }}</span
                    >
                  </b-col> -->
          ...
          <b-row v-if="isToken" class="w-100 mt-3">
            <b-col cols="12 ">
              ...
              <!-- <div class="mt-3 d-flex align-items-center" v-if="isChooseChild == true" style="cursor:pointer" @click="GoChooseChild">
                                <b-icon-person-plus scale="1.2" style="margin-left: 15px;margin-right: 5px;  display: inline;cursor:pointer" ></b-icon-person-plus>
                                <span  style="margin-left: 8px"> {{ $t('FilterChild') }} </span>
                            </div>
                            <div class="mt-3 d-flex align-items-center" v-if="isCourtApplication == true"  style="cursor:pointer" @click="GoCourtApplication">
                                <b-icon-file-earmark-medical scale="1.2" style="margin-left: 15px;margin-right: 5px;  display: inline;cursor:pointer" ></b-icon-file-earmark-medical>
                                <span  style="margin-left: 8px"> {{ $t('CourtApplication') }} </span>
                            </div> -->
              <!-- 
    ...
    >
      <img
        src="../assets/images/pinfl.jpg"
        alt
        class="img-fluid d-block mx-auto rounded m-0 p-0"
      />
    </b-modal>
...
export default {
  ...
  methods: {
    BindValue(data) {
      console.log(data);
      this.CheckPerson.passportDate = data;
    },
    ChangeSmsCode() {
    ...
    SearchbyEGov() {
      if (!this.CheckPerson.foreignStudent) {
        ...
        if (
        (this.CheckPerson.passportDate === "" ||
          this.CheckPerson.passportDate === 0 ||
          this.CheckPerson.passportDate === undefined ||
          this.CheckPerson.passportDate === null) ||
        this.CheckPerson.passportDate.split(".")[2] < 1991
      ) {
    ...
    GiveSmsCode() {
      ...
      // if (this.CheckPerson.passportDate.length == 0) {
      //   this.makeToast(this.$t("serianumbernotfull"), "error");
      //   return false;
      // }
      if (!this.CheckPerson.foreignStudent) {
      ...
      this.SearchbyEGov();
      this.countDownTimer();
      this.Account.passportDate = this.CheckPerson.passportDate;
      ...
      if (!this.filter.isSmsForRegister) {
        ...
        if (this.Account.smscode.length === 4) {
          ...
          await AccountService.CheckSMSCode(this.lang, {
            ...
            passportDate: this.CheckPerson.passportDate,
