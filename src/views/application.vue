  ...
  <div>
    ...
    <b-overlay :show="Loading" style="min-height: calc(100vh - 460px)">
      <div class="container" style="margin-top: 100px">
        <b-row>
          <b-col sm="12" lg="6" class="backTextView">
            <h2
              @click="$router.push('cabinet')"
              style="cursor: pointer"
              class="textbackviewstyle"
            >
          ...
          <b-col sm="12" lg="6" class="text-right">
            <!-- <a
              v-if="ApplicationList.addButton && Application.length != 0"
              href="javascript: void(0);"
              @click="
                $router.push({ name: 'EditApplication', params: { id: 0 } })
              "
              class="btn btn-sm anim-opacity btn-primary"
            >
        ...
        <!-- <b-row >
          <b-col sm="12" md="3" lg="3" v-for="(item,index) in EducationTypeList" :key="index">
                <custom-button @click="ChangeAdm(item)" block :variant="'success'"> {{ item.shortname }} </custom-button>
            </b-col>
            <custom-button block variant="success"> sdsds </custom-button>
        </b-row> -->
