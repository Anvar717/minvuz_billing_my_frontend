              ...
              <b-row>
                <b-col sm="12">
                  ...
                  <table class="my-table-padding">
                    ...
                    <!-- <tr class="my-1">
                      <td style="width: 45%">{{ $t("contractSumType") }} :</td>
                      <th style="width: 50%">
                        {{ item.contractSumType }}
                      </th>
                    </tr> -->
                    <tr class="my-1">
                    ...
                    <!-- <tr>
                      ...
                      <th style="width: 60%">
                        <span> {{$options.filters.currency(item.creditAmount, {symbol: '', fractionCount: 2})}}</span>
                      </th>
                    </tr> -->
                    <tr>
                      <td class="pr-btn" style="width: 40%">
...
export default {
  ...
  methods: {
    ...
    Invoice(item) {
      ...
      MyContractInvoiceService.InvoiceExcelToPdf(this.ContractInvoice.id2, this.ContractInvoice.amount)
        .then((res) => {
